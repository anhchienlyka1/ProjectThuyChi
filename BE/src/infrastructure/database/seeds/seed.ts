...
async function seed() {
    ...
    try {
        ...
        const achievementsList = [
            ...
            // Math Lesson Completion Achievement (Green Phiếu Bé Ngoan - Toán Học)
            { achievementId: 'math-lesson-completion', title: 'Phiếu Bé Ngoan - Toán Học', description: 'Hoàn thành tất cả bài tập Toán Học', icon: '🎖️', rarity: 'epic', points: 10, category: 'math_lesson' },
